...
<section class="login-sec" id="">
    ...
    <div class="container">
        ...
        <div id="signupbox" style="display:none; margin-top:0px" class="mainbox col-md-7 col-md-offset-3 col-sm-8 col-sm-offset-2">
                ...
                <div class="panel-body" >
                    <form id="signupform" class="form-horizontal" role="form" method="post" action="{{route('register')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="password" class="form-control" name="confirm_password" placeholder="Confim Password" required="required">
                            </div>
                        </div>
